...
The following chart shows distribution of casualties for the 100 most dangerous intersections in New Zealand.
```{r needlessplot}
  boxplot(highriskintersections$Total.Casualties)
```
